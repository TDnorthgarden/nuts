...
const (
	EventBusService_Publish_FullMethodName   = "/eventbus.EventBusService/Publish"
	EventBusService_Subscribe_FullMethodName = "/eventbus.EventBusService/Subscribe"
)
